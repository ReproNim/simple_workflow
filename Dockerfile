...
RUN mkdir -p /opt/repronim/simple_workflow/niflow-simple-workflow
COPY niflow-simple-workflow /opt/repronim/simple_workflow/niflow-simple-workflow
...
WORKDIR /opt/repronim/niflow-simple-workflow/test/scripts
